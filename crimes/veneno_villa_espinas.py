...
def crear_kb() -> KnowledgeBase:
    ...
    kb.add_rule(Rule(
        ...
        body=(
            Predicate("huellas_en", (X, Arma)),
            Predicate("es_arma", (Arma,)),
        )
    ))
